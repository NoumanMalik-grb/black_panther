	...
	if($('.price-range-slider').length){
		$( ".price-range-slider" ).slider({
			...
			slide: function( event, ui ) {
				$("input.property-amount").val(ui.values[0] );
				$("input.property-amount1").val(ui.values[1]);
			}
		});

		$("input.property-amount").val($(".price-range-slider").slider("values", 0));
		$("input.property-amount1").val($(".price-range-slider").slider("values", 1));
